...
<body>
    ...
    <main>
        <section class="hero">
            <h2>Welcome to the Future of Canteen Services</h2>
            <p>Smart Canteen brings Convenience,Speed,and Taste together in one place.</p>
            <a href="menu.html" class="btn">Explore Delicious Options</a>
        </section>
    </main>
    <footer>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Smart Canteen - Orders</title>
    <link rel="stylesheet" href="styles.css">
    <link rel="stylesheet" href="style.css">
</head>
<body>
    ...
    <main>
        <section class="admin">
            ...
            <form id="add-item-form">
                ...
                <input type="number" step="00.00" id="item-price" placeholder="Price" required>
